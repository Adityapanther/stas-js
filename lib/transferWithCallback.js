...
*/
function transferWithCallback (tokenOwnerPublicKey, stasUtxo, destinationAddress, paymentUtxo, paymentPublicKey, ownerSignatureCallback, paymentSignatureCallback, appendData) {
  ...
  let {stasScript, isAppendable} = updateStasScript(destinationPublicKey, stasUtxo.scriptPubKey, appendData)
  ...
  if (!isZeroFee) {
    handleChange(tx, paymentPublicKey, appendData)
    paymentSegment = {
