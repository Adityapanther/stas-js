...
const { isStasScript, P2PKH_UNLOCKING_SCRIPT_BYTES,checkIfStasFt, checkIfAppendable } = require('./stas')
 ...
 */
    function acceptSwapOffer(offerTxHex, makerInputTxHex,
      ...
      let takerIsStasFt = false
      let makerIsStasFt = false
      if(isTakerInputStasScript){
        takerIsStasFt = checkIfStasFt(takerInputScript.toHex())
      }
      if(isMakerInputStasScript){
        makerIsStasFt = checkIfStasFt(makerInputScript.toHex())
      }
      ...
      if (isMakerInputStasScript) {
        ...
        if(makerIsStasFt){
          makerUnlockScript = bsv.Script.fromASM(
            ...
            ' ' + preimageMaker)
        } else if(checkIfAppendable(makerInputScript.toHex())){
          makerUnlockScript = bsv.Script.fromASM(
            numberToLESM(tx.outputs[0].satoshis) + ' ' + makerPublicKeyHash +
            ' ' + 'OP_FALSE' +
            ' ' + numberToLESM(tx.outputs[1].satoshis) + ' ' + takerPublicKeyHash +
      ...
      if (isTakerInputStasScript) {
        ...
        } else if (checkIfAppendable(takerInputScript.toHex())){    
          takerUnlockScript = bsv.Script.fromASM(
            numberToLESM(tx.outputs[0].satoshis) + ' ' + makerPublicKeyHash +
            ' ' + 'OP_FALSE' +
            ' ' + numberToLESM(tx.outputs[1].satoshis) + ' ' + takerPublicKeyHash +
 ...
 */
  ...
  //   console.log(takerInputScript.toHex())
  //     const isTakerInputStasScript = isStasScript(takerInputScript.toHex())
  // console.log(isTakerInputStasScript)
  ...
  //     if(extraOutputs && extraOutputs.length){
