...
*/
function transfer (tokenOwnerPrivateKey, stasUtxo, destinationAddress, paymentUtxo, paymentPrivateKey, data) {
  ...
  return transferWithCallback(tokenOwnerPrivateKey.publicKey, stasUtxo, destinationAddress, paymentUtxo, paymentPrivateKey ? paymentPrivateKey.publicKey : null, ownerSignatureCallback, paymentSignatureCallback, data)
}
