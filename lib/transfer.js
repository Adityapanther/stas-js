...
*/
function transfer (tokenOwnerPrivateKey, stasUtxo, destinationAddress, paymentUtxo, paymentPrivateKey, appendData) {
  ...
  return transferWithCallback(tokenOwnerPrivateKey.publicKey, stasUtxo, destinationAddress, paymentUtxo, paymentPrivateKey ? paymentPrivateKey.publicKey : null, ownerSignatureCallback, paymentSignatureCallback, appendData)
}
